...
const dialog_lines : Array[String] = [
	"Narrator: (The Spaniards regroup, but Katipuneros seize the estate and cut off reinforcements. Aguinaldo confronts the Spanish officer.",
	"Teniente: “You peasants dare defy the Crown? You will be crushed!”",
	"Aguinaldo: “We are not peasants. We are Filipinos. And today, Cavite is free.”",
	"Narrator: (The officer is overwhelmed as Katipuneros secure the bridge. The Spaniards retreat in disarray.)"
