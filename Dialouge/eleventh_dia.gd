...
const dialog_lines : Array[String] = [
	"Narrator: (Spanish forces falter as traps and barricades slow their advance. Katipuneros surge forward, cutting down soldiers in fierce combat.)",
	"Teniente: “Fall back! Fall back! The rebels are too strong!”",
	"Aguinaldo: “Do not let them escape! Every step they retreat is a step toward our freedom!”",
	"Narrator:(The Spaniards retreat, leaving bodies scattered across the bridge. Katipuneros cheer, though many lie wounded.)"
]
