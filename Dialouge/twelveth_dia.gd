...
const dialog_lines : Array[String] = [
	"Narrator(The battlefield is quiet. Aguinaldo and Bonifacio stand among their men, exhausted but victorious.)",
	"Bonifacio: “We have paid dearly. Too many names will be remembered only in silence.”",
	"Aguinaldo: “But their sacrifice has given Cavite strength. Zapote Bridge is ours, and with it, hope for the nation.”",
	"Narrator: Katipuneros (chanting together)",
	"Narrator :“Mabuhay ang Kalayaan! Mabuhay ang Katipunan!”"
]
