...
const dialog_lines : Array[String] = [
	"Narrator: (Spanish troops approach the Imus bridge. Aguinaldo signals his men hidden among the trees and estate walls.)",
	"Teniente:	“Filipino rebels with bolos think they can defeat Spain? Crush them quickly.”",
	"Aguinaldo: “Hold… hold… now!”",
	"Narrator: (Gunfire and bolos erupt. Katipuneros swarm from cover, cutting off the bridge. The Spaniards falter as the terrain traps them.",
	"Bonifacio: “Push them back! For our fallen brothers at San Juan del Monte!”"
]
