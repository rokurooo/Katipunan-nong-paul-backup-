...
func _on_level_1_pressed() -> void:
	button_sfx.play()
	SceneTransition.change_scene("res://Dialouge/fifth_dia.tscn")

func _on_level_2_pressed() -> void:
	button_sfx.play()
	SceneTransition.change_scene("res://Scenes and Scripts/cavity.tscn")

func _on_level_3_pressed() -> void:
	button_sfx.play()
	SceneTransition.change_scene("res://cavity_2.tscn")
